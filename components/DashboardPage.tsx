    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-neutral-50">
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href="/public" className="text-neutral-600 hover:text-primary-700 transition-colors">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                >
                    <Link href="/public#booking" className="bg-primary-700 text-white rounded-2xl p-6 hover:bg-primary-800 transition-all">
                    ...
                    <Link href="/public#contact" className="bg-white rounded-2xl p-6 border-2 border-neutral-200 hover:border-primary-700 transition-all">

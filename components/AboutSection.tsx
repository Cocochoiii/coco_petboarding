                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="mb-6 text-center lg:text-left">
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold mt-2 mb-6 text-neutral-900">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.6 }}
                        className="relative max-w-xl mx-auto lg:max-w-none mt-4 lg:mt-0"
                    >
                        {/* Feature Card with Better Interactions */}
                        <motion.div
                            className="bg-gradient-to-br from-neutral-50 to-white rounded-3xl p-6 md:p-8 shadow-soft-xl border-2 border-neutral-100 hover:border-primary-700 transition-all"
                        ...
                        >
                            ...
                            <motion.div
                                className="mt-8 p-5 md:p-6 bg-white rounded-2xl shadow-soft-md border-2 border-neutral-100 hover:border-primary-700 transition-all"
                                whileHover={{ scale: 1.02 }}
                            >
                                <div className="flex items-center gap-4">
                                    <motion.div
                                        className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-primary-700 to-primary-800 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-soft-lg"
                                        whileHover={{ rotate: 360 }}
                                        transition={{ duration: 0.5 }}
                                    >
                                        CC
                                    ...
                                    <div>
                                        <h4 className="font-bold text-base md:text-lg text-neutral-900">
                                            Coco Choi
                                        </h4>
                                        ...
                                        <div className="flex items-center gap-1 mt-1">
                                            ...
                                            <span className="text-xs md:text-sm text-neutral-500 ml-1">
                                                5.0 rating
                                            </span>
                                        </div>
                                    </div>
                            ...
                            {/* CTA Button */}
                            <motion.button
                                className="mt-6 w-full btn-primary py-3 rounded-xl font-semibold group text-sm md:text-base"
                                whileHover={{ scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                            >
                        ...
                        <motion.div
                            className="absolute -top-4 -right-4 text-5xl md:text-6xl opacity-5"
                            animate={{
                                rotate: [0, 5, -5, 0]
                            }}
                            transition={{
